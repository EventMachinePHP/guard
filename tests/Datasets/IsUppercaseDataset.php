...
dataset(failingCasesDataset(filePath: __FILE__), [
    "('Abc123')"       => ['Abc123', 'Expected uppercase characters only. Got: "Abc123" (string)'],
    "('abc')"          => ['abc', 'Expected uppercase characters only. Got: "abc" (string)'],
    "('')"             => ['', 'Expected uppercase characters only. Got: "" (string)'],
